...
if($newPassword != $confirmPassword){
    ...
    $sqlUpdate = "UPDATE tbl_patrons SET patron_password = '$confirmPassword' WHERE Library_ID = '$accID'";
    $result6=mysqli_query($conn, $sqlUpdate);

    if($result6){
        echo "Data Inserted Succesfully!";
        header("Location:user-profiles-student.php");
    }else{
                ...
                <div class="tab-pane show active fade pt-3" id="profile-change-password">
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="id" type="text" value="<?php echo ($_SESSION["Library_ID"]) ?>" readonly class="form-control" id="currentPassword">
                      </div>
                    </div>
