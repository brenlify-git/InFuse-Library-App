...
<head>
    ...
    <title>InFuse | Admin Membership</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Admin's Membership</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                    <li class="breadcrumb-item active">Admin's Membership</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Insert Admin's Details</h5>


                            <!-- Multi Columns Form -->
                            <form class="row g-3" action="add-admin.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select" aria-label="Default select example" name="adminType"
                                            required>
