...
<body>
    ...
    <table class="table">
        ...
        <tbody>
          <tr>
            <td scope="row" class="empIDS">{{ empID }}</td>
            <td>{{ firstnamee }}</td>
            <td>{{ middlename }}</td>
            <td>{{ lastname }}</td>
          </tr>
          ...
          <tr>
            <td scope="row" colspan="2" class="qrcode"><img class="qrcode" src="{{ qrcode }}"></td>
            <td scope="row" colspan="2" class="qrcode"><img class="profilePic" src="{{ profilePic }}"></td>
          </tr>
