...
<body>
  ...
  <?php include_once 'headerbar-librarian.php';?>
  <?php include 'sidebar-librarian.php'; 
  $utype = strtolower($_SESSION["librarian_type"]);
  ?>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2><?php echo ucfirst($_SESSION["librarian_username"]) ?></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo ucfirst($_SESSION["librarian_username"]) ?></div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="assets/img/Robles, Brenley Ian_BSIT3.png" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo ucfirst($_SESSION["librarian_username"]) ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="NU Baliwag">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="job" type="text" class="form-control" id="Job" value="<?php echo ucwords($utype) ?>">
                      </div>
                    </div>
