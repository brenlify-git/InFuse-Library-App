            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="update.php" method="POST">
                    ...
                    <div class="col-4">
                      ...
                      <input type="number" class="form-control" min="1" step="any" id="price" placeholder="567.00" name="Price" required>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-6">
                      ...
                      <textarea type="number" class="form-control" id="notes" placeholder="Cover page has dirt marks." required name="Notes"></textarea>
                    </div>
                  
                    <div class="d-flex align-items-baseline">

                      <div class="update col-6">
                        <button type="submit" class="btn btn-primary col-12" name="updateData"><i class="bi bi-pencil-square"></i> Update</button>
                      </div>
